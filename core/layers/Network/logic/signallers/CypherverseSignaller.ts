...
export class CypherverseSignaller implements Signaller {
  sessionId: string;
  ...
  constructor(peer: Peer, config: Partial<SignallerConfig> = {}) {
    console.info("using cypherverse signaller");
    ...
    this.host = config.host || "https://cypherverse-web.onrender.com";
