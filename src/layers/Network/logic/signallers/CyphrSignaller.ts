...
export class CyphrSignaller implements Signaller {
  sessionId: string;
  ...
  constructor(peer: Peer, config: Partial<SignallerConfig> = {}) {
    console.info("using cyphr signaller");
    ...
    this.host = config.host || process.env.REACT_APP_SIGNALLER_HOST || window.location.origin;
